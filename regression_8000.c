 ...
 * From https://github.com/brycx/Test-Vector-Generation
 * Test cases compatible with RFC 6070 input parameters
 */

/* SHA224 Test Case 1 - uses same input as RFC 6070 test 1 */
...
/* SHA224 Test Case 2 - uses same input as RFC 6070 test 2 */
...
/* SHA224 Test Case 3 - uses same input as RFC 6070 test 3 */
...
/* SHA224 Test Case 4 - uses same input as RFC 6070 test 4 (lengthy test) */
...
/* SHA256 Test Case 1 - uses same input as RFC 6070 test 1 */
...
/* SHA256 Test Case 2 - uses same input as RFC 6070 test 2 */
...
/* SHA256 Test Case 3 - uses same input as RFC 6070 test 3 */
...
/* SHA256 Test Case 4 - uses same input as RFC 6070 test 4 (lengthy test) */
...
static const uint8_t pbkdf2_sha256_4_dkm[] = {
	...
	0xf1, 0x31, 0xec, 0xb6, 0x5d, 0xab, 0x40, 0x89,
	0xf7, 0xf1, 0x79, 0xe8
};
...
/* SHA384 Test Case 1 - uses same input as RFC 6070 test 1 */
...
/* SHA384 Test Case 2 - uses same input as RFC 6070 test 2 */
...
/* SHA384 Test Case 3 - uses same input as RFC 6070 test 3 */
...
/* SHA384 Test Case 4 - uses same input as RFC 6070 test 4 (lengthy test) */
...
/* SHA512 Test Case 1 - uses same input as RFC 6070 test 1 */
...
/* SHA512 Test Case 2 - uses same input as RFC 6070 test 2 */
...
/* SHA512 Test Case 3 - uses same input as RFC 6070 test 3 */
...
/* SHA512 Test Case 4 - uses same input as RFC 6070 test 4 (lengthy test) */
 ...
 * Generated using RFC 6070 input parameters (same as HMAC-SHA1 tests)
 * SM3 is a Chinese cryptographic hash function (GM/T 0004-2012)
 */

/* SM3 Test Case 1 - uses same input as RFC 6070 test 1 */
...
/* SM3 Test Case 2 - uses same input as RFC 6070 test 2 */
...
static const uint8_t pbkdf2_sm3_2_dkm[] = {
	0xb8, 0xf5, 0xda, 0x80, 0x1d, 0x6b, 0xa0, 0xeb,
	0x2b, 0xca, 0x49, 0xd5, 0xc7, 0xbd, 0xbf, 0xde,
	0xf5, 0xda, 0x80, 0x1d
};

/* SM3 Test Case 3 - uses same input as RFC 6070 test 3 */
...
static const uint8_t pbkdf2_sm3_3_dkm[] = {
	0x67, 0x49, 0x59, 0x1a, 0x71, 0x42, 0xc6, 0x35,
	0xf4, 0x80, 0x00, 0x21, 0x86, 0xfe, 0x07, 0x7f,
	0x49, 0x59, 0x1a, 0x71
};

/* SM3 Test Case 4 - uses same input as RFC 6070 test 4 (lengthy test, level 15) */
#define pbkdf2_sm3_4_password pbkdf2_4_password
#define pbkdf2_sm3_4_salt pbkdf2_4_salt
#define pbkdf2_sm3_4_iteration_count pbkdf2_4_iteration_count
static const uint8_t pbkdf2_sm3_4_dkm[] = {
	0x84, 0x50, 0xc8, 0x13, 0x49, 0x1f, 0x29, 0xa1,
	0x18, 0xe5, 0xf0, 0x89, 0x99, 0x73, 0x6f, 0x15,
	0x65, 0xa0, 0xa9, 0x34
};
...
#define pbkdf2_sm3_5_iteration_count pbkdf2_5_iteration_count
static const uint8_t pbkdf2_sm3_5_dkm[] = {
	0xcb, 0x6a, 0x3f, 0x09, 0xb6, 0xe1, 0x03, 0xc3,
	0x25, 0x17, 0xff, 0x3c, 0xa5, 0x6a, 0xca, 0xd4,
	0x6a, 0x3f, 0x09, 0xb6, 0xe1, 0x03, 0xc3, 0x25,
	0x17, 0xff, 0x3c, 0xa5, 0x6a, 0xca, 0xd4,
	0x1b, 0x4f, 0x0e, 0xe5, 0x29, 0x84, 0xb2, 0x62, 0x2f
};

/* SM3 Test Case 6 */
static const uint8_t pbkdf2_sm3_6_password[] = {
	'p', 'a', 's', 's', '\0', 'w', 'o', 'r',
	'd',
};

static const uint8_t pbkdf2_sm3_6_salt[] = {
	's', 'a', '\0', 'l', 't'
};

#define pbkdf2_sm3_6_iteration_count pbkdf2_6_iteration_count
static const uint8_t pbkdf2_sm3_6_dkm[] = {
	0xa6, 0xd9, 0xc1, 0xe9, 0x91, 0xd9, 0x00, 0x4d,
	0x99, 0x15, 0x36, 0x34, 0x0c, 0xbd, 0x3d, 0x1a
};
...
/* Helper macro for SHA2 test cases using shared RFC 6070 inputs */
#define SHA2_TEST(l, algo, hash, n) \
	TEST_PBKDF2_DATA(l, "PBKDF2-HMAC-" #hash " test " TO_STR(n), \
			 algo, sha##hash##_##n, false)

/* Helper macro for SM3 test cases (SM3 is lowercase in variable names) */
#define SM3_TEST(l, n) \
...
#define RFC6070_TEST(l, n) \
	...
	static struct pbkdf2_case {
		...
		/* PBKDF2-HMAC-SHA224 tests (same inputs as RFC 6070) */
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 1),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 2),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 3),
		SHA2_TEST(15, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 4),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 5),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA224_DERIVE_KEY, 224, 6),

		/* PBKDF2-HMAC-SHA256 tests (same inputs as RFC 6070) */
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 1),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 2),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 3),
		SHA2_TEST(15, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 4),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 5),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA256_DERIVE_KEY, 256, 6),

		/* PBKDF2-HMAC-SHA384 tests (same inputs as RFC 6070) */
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 1),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 2),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 3),
		SHA2_TEST(15, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 4),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 5),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA384_DERIVE_KEY, 384, 6),

		/* PBKDF2-HMAC-SHA512 tests (same inputs as RFC 6070) */
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 1),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 2),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 3),
		SHA2_TEST(15, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 4),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 5),
		SHA2_TEST(0, TEE_ALG_PBKDF2_HMAC_SHA512_DERIVE_KEY, 512, 6),

		/* PBKDF2-HMAC-SM3 tests (same inputs as RFC 6070) */
		SM3_TEST(0, 1), SM3_TEST(0, 2), SM3_TEST(0, 3),
		SM3_TEST(15, 4), SM3_TEST(0, 5), SM3_TEST(0, 6),
	};
	size_t max_size = 2048;
